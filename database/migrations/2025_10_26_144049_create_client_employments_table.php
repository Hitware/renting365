...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('client_employments', function (Blueprint $table) {
            ...
            $table->enum('employment_type', ['empleado_indefinido', 'empleado_temporal', 'prestacion_servicios', 'independiente', 'pensionado']);
            ...
            $table->text('monthly_salary'); // Cifrado
            $table->text('other_income')->nullable(); // Cifrado
            $table->text('total_monthly_income'); // Cifrado
