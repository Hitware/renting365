                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="document_type" id="document_type" required
                                ...
                                <option value="CC" {{ old('document_type', $user->profile->document_type ?? '') == 'CC' ? 'selected' : '' }}>Cédula de Ciudadanía</option>
                                <option value="CE" {{ old('document_type', $user->profile->document_type ?? '') == 'CE' ? 'selected' : '' }}>Cédula de Extranjería</option>
                                <option value="TI" {{ old('document_type', $user->profile->document_type ?? '') == 'TI' ? 'selected' : '' }}>Tarjeta de Identidad</option>
                                <option value="PP" {{ old('document_type', $user->profile->document_type ?? '') == 'PP' ? 'selected' : '' }}>Pasaporte</option>
                            </select>
                            @error('document_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="document_number" id="document_number" value="{{ old('document_number', $user->profile->document_number ?? '') }}" required
