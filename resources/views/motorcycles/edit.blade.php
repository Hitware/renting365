    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6 bg-gradient-to-r from-orange-500 to-orange-600">
                ...
                <p class="text-sm text-orange-100 mt-1">Actualice los campos que desee modificar</p>
            </div>

            <form action="{{ route('motorcycles.update', $motorcycle->id) }}" method="POST" class="p-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="brand" id="brand" value="{{ old('brand', $motorcycle->brand) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="model" id="model" value="{{ old('model', $motorcycle->model) }}" required
                        ...
                        <div>
                            ...
                            <input type="number" name="year" id="year" value="{{ old('year', $motorcycle->year) }}" required min="1900" max="{{ date('Y') + 1 }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="displacement" id="displacement" value="{{ old('displacement', $motorcycle->displacement) }}" required placeholder="ej: 150cc"
                        ...
                        <div>
                            ...
                            <input type="text" name="color" id="color" value="{{ old('color', $motorcycle->color) }}"
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="active" {{ old('status', $motorcycle->status) == 'active' ? 'selected' : '' }}>Activa</option>
                                <option value="in_maintenance" {{ old('status', $motorcycle->status) == 'in_maintenance' ? 'selected' : '' }}>En Mantenimiento</option>
                                <option value="damaged" {{ old('status', $motorcycle->status) == 'damaged' ? 'selected' : '' }}>Dañada</option>
                                <option value="sold" {{ old('status', $motorcycle->status) == 'sold' ? 'selected' : '' }}>Vendida</option>
                                <option value="inactive" {{ old('status', $motorcycle->status) == 'inactive' ? 'selected' : '' }}>Inactiva</option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="plate" id="plate" value="{{ old('plate', $motorcycle->plate) }}" required placeholder="ABC123"
                        ...
                        <div>
                            ...
                            <input type="text" name="motor_number" id="motor_number" value="{{ old('motor_number', $motorcycle->motor_number) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="chassis_number" id="chassis_number" value="{{ old('chassis_number', $motorcycle->chassis_number) }}" required
                        ...
                        <div>
                            ...
                            <select name="current_owner_id" id="current_owner_id"
                                ...
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}" {{ old('current_owner_id', $motorcycle->current_owner_id) == $user->id ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="purchase_price" id="purchase_price" value="{{ old('purchase_price', $motorcycle->purchase_price) }}" step="0.01" min="0"
                        ...
                        <div>
                            ...
                            <input type="date" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', $motorcycle->purchase_date) }}"
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('notes') border-red-500 @enderror">{{ old('notes', $motorcycle->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
