        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white rounded-xl shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Total Pagos Hoy</p>
                            <p class="text-3xl font-bold text-gray-900">{{ $todayPayments->count() }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600">${{ number_format($todayPayments->sum('amount'), 0, ',', '.') }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-red-600">{{ $todayPayments->where('status', 'atrasado')->count() }}</p>
                        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('leasing-contracts.show', $payment->contract) }}" class="text-orange-600 hover:text-orange-900 mr-3">
                                        Ver Contrato
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    ...
                                    <p class="text-gray-500">No hay pagos programados para hoy</p>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
