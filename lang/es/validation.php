...
return [
    ...
    'attributes' => [
        ...
        'dependents_count' => 'personas a cargo',
        'address' => 'dirección',
        'neighborhood' => 'barrio',
        'city' => 'ciudad',
        'department' => 'departamento',
        'phone_mobile' => 'teléfono celular',
        'phone_landline' => 'segundo teléfono',
        'email' => 'correo electrónico',
        'total_income' => 'ingresos totales',
        'total_expenses' => 'egresos totales',
        'rent_expense' => 'gasto en arriendo',
        'utilities_expense' => 'gasto en servicios',
        'food_expense' => 'gasto en alimentación',
        'consent_data_treatment' => 'autorización de tratamiento de datos',
        'consent_credit_query' => 'autorización de consulta crediticia',
    ],
];
